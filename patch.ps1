...
# ── Expose RimWorldDir to MSBuild (used in Helpers.csproj HintPaths) ─────────
...
# ── Restore mode — skip build entirely ───────────────────────────────────────
if ($Restore) {
